...
public class AddTaskActivity extends AppCompatActivity {
    ...
    public void onClickAddTask(View view) {
        // Not yet implemented
        int valueOfText = mEditText.getText().length();
        ...
        mCv.put(TaskContract.TaskEntry.COLUMN_DESCRIPTION,userInput);
        mCv.put(TaskContract.TaskEntry.COLUMN_PRIORITY,mPriority);

        Uri uri = getContentResolver().insert(TaskContract.TaskEntry.CONTENT_URI,mCv);
        ...
        if(uri != null){
            Toast.makeText(getApplicationContext(),"New URI: " + uri.toString(), Toast.LENGTH_LONG).show();
        }
        finish();
